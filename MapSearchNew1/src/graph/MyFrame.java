...
public class MyFrame extends JFrame implements ActionListener {
	...
	private JRadioButton radDirected,radUndirected, radDraw ;
	...
	private JPanel creatSelectPanel() {
		...
		panelMapTypeTemp
		.add(radDirected = createRadioButton("Directed", true));//false
		ButtonGroup groupMapType = new ButtonGroup();
		
		panelMapTypeTemp
		.add(radUndirected = createRadioButton("Undirected", false));//false
		ButtonGroup groupMapType1 = new ButtonGroup();
	
		groupMapType.add(radDirected);
		groupMapType1.add(radUndirected);
	...
	public void actionPerformed(ActionEvent e) {
		...
		// select Map type
		if (e.getSource() == radDirected) {
			setEnableMapType(false);
		}else if
			(e.getSource() == radUndirected){
